            ...
            <div className="row">
              <div className="section-login col-lg-6 ml-auto mr-auto">
                ...
                <div className="card-login card mb-3">
                  <div className="card-body">
                    ...
                    <div className="alert alert-success text-center" role="alert">
                      Konto angelegt.<br />
                      <Link to="/" href="/">Verwenden Sie die Anmeldedaten um die Anmeldung durchzuführen.</Link>
                    </div>
                    }
                    ...
                    <form className="form-horizontal" method="POST" onSubmit={this.handleSubmit} ref={(el) => { this.registrationForm = el; }}>
                      ...
                      <div className="form-group">
                        <label htmlFor="password_confirmation">Kennwortbestätigung</label>
                        <input
                ...
                <div className="password-reset-link text-center">
                  <Link to="/" href="/">
                    Sie haben ein Konto bereits? Hier anmelden.
                  </Link>
                </div>
                }
              </div>
