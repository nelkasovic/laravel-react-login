                ...
                <div className="card-login card mb-3">
                  <div className="card-body">
                    ...
                    <div className="alert alert-danger text-center" role="alert">
                      Anmeldedaten nicht korrekt, bitte erneut versuchen!
                    </div>
                    }
                    ...
                    <form className="form-horizontal" method="POST" onSubmit={this.handleSubmit} ref={(el) => { this.loginForm = el; }}>
                      ...
                      <div className="login-invite-text text-center">Kein Konto? <Link to="/register" href="/register">Hier Konto eröffnen.</Link>.</div>
                    </form>
                  </div>
                </div>
